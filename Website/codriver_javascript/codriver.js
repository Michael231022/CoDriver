    ...
    const login_btn_dropdown = document.querySelector('.login-btn-dropdown') 
    
    login_btn.addEventListener('click', () => {
        if (login_btn_dropdown.style.display == 'block') {
            login_btn_dropdown.style.display = 'none';
    
        }
        else {
            login_btn_dropdown.style.display = 'block';
        }
    });
    ...
    /******************************** SwiftMIC WALLET ********************************/
    const swiftmic_title = document.querySelector('.swiftmic-title');
    ...
    window.addEventListener('resize', function() {
        ...
        if (screenWidth < 818) {
            swiftmic_title.innerHTML = 'SwiftMIC';
        }

        else if (screenWidth > 818) {
            swiftmic_title.innerHTML = 'SwiftMIC Wallet';
        }
    });
